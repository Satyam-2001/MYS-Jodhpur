...
function SectionContainer({ children, sx, color }) {
    const theme = useTheme()
    return (
        <Fragment>
...
function SelectSection({ color = 'primary' }) {
    const theme = useTheme()
    const mode = theme.palette.mode
...
function RegisterSection({ color = 'primary' }) {
    const theme = useTheme()

    return (
        <SectionContainer color={color} sx={{ alignItems: 'center' }}>
...
function CommunitySection({ color = 'primary' }) {
    const theme = useTheme()

    return (
        <SectionContainer color={color} sx={{ px: 0 }}>
...
function HeroSection(props) {
    ...
    return (
        <Fragment>
            <SelectSection color='secondary' />
            <RegisterSection />
            <CommunitySection color='secondary' />
        </Fragment>
    )
}
