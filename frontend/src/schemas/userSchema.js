...
import { about_me, address, complexion, date_of_birth, diet, disability, disease, education, email, father_name, father_occupation, gender, gotra_nanihal, gotra_self, height, income, kundli_milan, location, manglik, martial_status, mother_name, mother_occupation, name, occupation, phone_number, place_of_birth, profile_managed_by, time_of_birth, web_link, weight_category } from ".";
