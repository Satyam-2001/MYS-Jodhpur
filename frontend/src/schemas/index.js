...
export const date_of_birth = Yup.date().required('Please enter your date of birth')
export const time_of_birth = Yup.date().required('Please enter your time of birth')
export const place_of_birth = Yup.string().required('Please enter your place of birth')
...
export const location = Yup.string().required('Please enter your location').max(30, 'Only write the city/town name')
export const height = Yup.number().required('Please enter your height').min(24, 'Height is too short').max(90, 'Height is too long')
export const manglik = Yup.string().required('Please enter your manglik status').max(25, 'Too long string')
...
export const web_link = Yup.string().matches(url, 'Enter correct url')
