...
export function elevation(value = 0) {
    if (value >= 0) {
        return {
            ...
            md: '0px 0px 3px 0px rgba(0, 0, 0, 0.2), inset 6px 6px 14px -5px rgba(255,255,255,0.06), 4px 4px 8px -5px rgba(0, 0, 0, 0.7)'
        }
    }
    return {
        xs: `inset -6px -6px 14px -5px rgba(255,255,255,0.06), inset ${2 * -value}px ${4 * -value}px ${8 * -value}px -5px rgba(0, 0, 0, ${0.35 * -value})`,
        md: 'inset -6px -6px 14px -5px rgba(255,255,255,0.06), inset 4px 4px 11px -5px rgba(0, 0, 0, 0.75)'
    }
}